package moe.sandie.workerants.util;
...
public class Lang {
    ...
    private static WorkerAntsAPI plugin;
    ...
    public static void init(final WorkerAntsAPI plugin, String iso) throws InvalidConfigurationException, IOException {
        Lang.plugin = plugin;
        ...
        for (final Map.Entry<String, String> entry : allStrings.entrySet()) {
    ...
    private static class LangToken {
        ...
        public static String convertString(String s) {
            ...
            for (final Map.Entry<String, String> token : tokenMap.entrySet()) {
